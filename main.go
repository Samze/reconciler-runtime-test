...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "82b1bc55.example.org",
	})
	if err != nil {
	...
	reconCfg := reconcilers.NewConfig(mgr, &testv1alpha1.Bar{}, time.Minute)
	reconciler := controllers.BarReconciler(reconCfg)

	if err = reconciler.SetupWithManager(context.TODO(), mgr); err != nil {
